...
public class HomeAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			// viewHolder.flipLayout= (FlipLayout)
			// convertView.findViewById(R.id.flipLayout);
	...
	private void downImg(final int id) {
		...
		HttpHandler handler = http.download(Conf.APP_IMG + id + ".jpg",
				"/sdcard/zhidu/+" + id + ".jpg", true, // 如果目标文件存在，接着未完成的部分继续下载。服务器不支持RANGE时将从新下载。
